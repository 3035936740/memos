...
export type UserStats = Message<"memos.api.v1.UserStats"> & {
   ...
   *
   * @generated from field: int32 total_comment_count = 9;
   */
...
export type UserNotification_SpaceInvitationPayload = Message<"memos.api.v1.UserNotification.SpaceInvitationPayload"> & {
  ...
  /**
   * The pending invitation resource accepted or declined by the receiver.
   *
   * @generated from field: string invitation = 2;
   */
  invitation: string;

  /**
   * @generated from field: string space_title = 3;
   */
  spaceTitle: string;

  /**
   * @generated from field: string space_avatar_url = 4;
   */
  spaceAvatarUrl: string;

  /**
   * @generated from field: string space_description = 5;
   */
