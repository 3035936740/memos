...
const (
	...
	VoterType_AUTHENTICATED          VoterType = 1
	VoterType_ANYONE                 VoterType = 2
)
...
type Memo struct {
	...
	Draft bool `protobuf:"varint,21,opt,name=draft,proto3" json:"draft,omitempty"`
	...
	PublishTime *timestamppb.Timestamp `protobuf:"bytes,22,opt,name=publish_time,json=publishTime,proto3,oneof" json:"publish_time,omitempty"`
...
func (x *Memo) GetPublishTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Memo) GetQuarantined() bool {
	if x != nil {
...
func (x *Memo) GetViewCount() int64 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
func (x *ListMemosRequest) GetPageOffset() int32 {
	if x != nil {
		return x.PageOffset
	}
	return 0
...
func (x *ListMemosRequest) GetShowTotalSize() bool {
	if x != nil {
		return x.ShowTotalSize
	}
	return false
}
...
type Poll struct {
	...
	Image *Attachment `protobuf:"bytes,2,opt,name=image,proto3" json:"image,omitempty"`
	// The poll choices.
	...
	VoterType VoterType `protobuf:"varint,10,opt,name=voter_type,json=voterType,proto3,enum=memos.api.v1.VoterType" json:"voter_type,omitempty"`
	...
	SelectedOptionIds []string `protobuf:"bytes,8,rep,name=selected_option_ids,json=selectedOptionIds,proto3" json:"selected_option_ids,omitempty"`
	// Hide counts and percentages until the current viewer has voted.
	HideResultsUntilVoted bool `protobuf:"varint,11,opt,name=hide_results_until_voted,json=hideResultsUntilVoted,proto3" json:"hide_results_until_voted,omitempty"`
	// For authenticated-only polls, reveal participants before the viewer votes.
	ShowVotersBeforeVoting bool `protobuf:"varint,12,opt,name=show_voters_before_voting,json=showVotersBeforeVoting,proto3" json:"show_voters_before_voting,omitempty"`
	// For authenticated-only polls, reveal participants after the viewer votes.
	ShowVotersAfterVoting bool `protobuf:"varint,13,opt,name=show_voters_after_voting,json=showVotersAfterVoting,proto3" json:"show_voters_after_voting,omitempty"`
	// Output only. True when counts are withheld for this viewer.
	ResultsHidden bool `protobuf:"varint,14,opt,name=results_hidden,json=resultsHidden,proto3" json:"results_hidden,omitempty"`
	// Output only. Random sample of at most ten unique participants, only when visible.
	Voters []*PollVoter `protobuf:"bytes,15,rep,name=voters,proto3" json:"voters,omitempty"`
	// Output only. Whether the participant list is visible to this viewer.
	VotersVisible bool `protobuf:"varint,16,opt,name=voters_visible,json=votersVisible,proto3" json:"voters_visible,omitempty"`
	// Reveal selected choices for visible participants. Authenticated-only polls.
	ShowVoterChoices bool `protobuf:"varint,17,opt,name=show_voter_choices,json=showVoterChoices,proto3" json:"show_voter_choices,omitempty"`
	// Output only. More participants exist than the random sample of at most ten.
	HasMoreVoters bool `protobuf:"varint,18,opt,name=has_more_voters,json=hasMoreVoters,proto3" json:"has_more_voters,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Poll) GetImage() *Attachment {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *Poll) GetMaxSelections() int32 {
	if x != nil {
...
func (x *Poll) GetVoterType() VoterType {
	if x != nil {
		return x.VoterType
	}
...
func (x *Poll) GetSelectedOptionIds() []string {
	if x != nil {
...
func (x *Poll) GetHideResultsUntilVoted() bool {
	if x != nil {
...
func (x *Poll) GetShowVotersBeforeVoting() bool {
	if x != nil {
...
func (x *Poll) GetShowVotersAfterVoting() bool {
	if x != nil {
...
func (x *Poll) GetResultsHidden() bool {
	if x != nil {
		return x.ResultsHidden
	}
	return false
}

func (x *Poll) GetVoters() []*PollVoter {
	if x != nil {
		return x.Voters
	}
	return nil
...
func (x *Poll) GetVotersVisible() bool {
	if x != nil {
		return x.VotersVisible
	}
	return false
}

func (x *Poll) GetShowVoterChoices() bool {
	if x != nil {
...
func (x *Poll) GetHasMoreVoters() bool {
	if x != nil {
		return x.HasMoreVoters
	}
	return false
}
...
func (x *PollVoter) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *PollVoter) GetAvatarUrl() string {
	if x != nil {
		return x.AvatarUrl
	}
	return ""
...
func (x *PollVoter) GetSelectedOptionIds() []string {
	if x != nil {
		return x.SelectedOptionIds
	}
	return nil
...
type PollOption struct {
	...
	Image *Attachment `protobuf:"bytes,3,opt,name=image,proto3" json:"image,omitempty"`
...
func (x *PollOption) GetImage() *Attachment {
	if x != nil {
		return x.Image
	}
	return nil
...
type RecordMemoViewRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RecordMemoViewRequest) Reset() {
	*x = RecordMemoViewRequest{}
	mi := &file_api_v1_memo_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RecordMemoViewRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecordMemoViewRequest) ProtoMessage() {}

func (x *RecordMemoViewRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_memo_service_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecordMemoViewRequest.ProtoReflect.Descriptor instead.
func (*RecordMemoViewRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{10}
}

func (x *RecordMemoViewRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RecordMemoViewRequest) GetShareToken() string {
	if x != nil {
		return x.ShareToken
	}
	return ""
...
type RecordMemoViewResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RecordMemoViewResponse) Reset() {
	*x = RecordMemoViewResponse{}
	mi := &file_api_v1_memo_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RecordMemoViewResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecordMemoViewResponse) ProtoMessage() {}

func (x *RecordMemoViewResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_memo_service_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecordMemoViewResponse.ProtoReflect.Descriptor instead.
func (*RecordMemoViewResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{11}
}

func (x *RecordMemoViewResponse) GetViewCount() int64 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\x06hidden\x18\x14 \x01(\bB\x03\xe0A\x01R\x06hidden\x12\x19\n" +
	"\x05draft\x18\x15 \x01(\bB\x03\xe0A\x01R\x05draft\x12G\n" +
	...
	"\thide_time\x18\x1e \x01(\bB\x03\xe0A\x01R\bhideTime\x12+\n" +
	"\x04poll\x18\x1f \x01(\v2\x12.memos.api.v1.PollB\x03\xe0A\x01R\x04poll\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
	...
	"\x05scope\"\xab\a\n" +
	"\x04Poll\x12\x1f\n" +
	"\bquestion\x18\x01 \x01(\tB\x03\xe0A\x02R\bquestion\x123\n" +
	"\x05image\x18\x02 \x01(\v2\x18.memos.api.v1.AttachmentB\x03\xe0A\x01R\x05image\x127\n" +
	"\aoptions\x18\x03 \x03(\v2\x18.memos.api.v1.PollOptionB\x03\xe0A\x02R\aoptions\x12*\n" +
	"\x0eallow_multiple\x18\x04 \x01(\bB\x03\xe0A\x01R\rallowMultiple\x12*\n" +
	"\x0emax_selections\x18\t \x01(\x05B\x03\xe0A\x01R\rmaxSelections\x12;\n" +
	"\n" +
	"voter_type\x18\n" +
	" \x01(\x0e2\x17.memos.api.v1.VoterTypeB\x03\xe0A\x01R\tvoterType\x12>\n" +
	"\n" +
	"start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\tstartTime\x12:\n" +
	"\bend_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\aendTime\x12$\n" +
	"\vtotal_votes\x18\a \x01(\x05B\x03\xe0A\x03R\n" +
	"totalVotes\x123\n" +
	"\x13selected_option_ids\x18\b \x03(\tB\x03\xe0A\x03R\x11selectedOptionIds\x12<\n" +
	"\x18hide_results_until_voted\x18\v \x01(\bB\x03\xe0A\x01R\x15hideResultsUntilVoted\x12>\n" +
	"\x19show_voters_before_voting\x18\f \x01(\bB\x03\xe0A\x01R\x16showVotersBeforeVoting\x12<\n" +
	"\x18show_voters_after_voting\x18\r \x01(\bB\x03\xe0A\x01R\x15showVotersAfterVoting\x12*\n" +
	"\x0eresults_hidden\x18\x0e \x01(\bB\x03\xe0A\x03R\rresultsHidden\x124\n" +
	"\x06voters\x18\x0f \x03(\v2\x17.memos.api.v1.PollVoterB\x03\xe0A\x03R\x06voters\x12*\n" +
	"\x0evoters_visible\x18\x10 \x01(\bB\x03\xe0A\x03R\rvotersVisible\x121\n" +
	"\x12show_voter_choices\x18\x11 \x01(\bB\x03\xe0A\x01R\x10showVoterChoices\x12+\n" +
	"\x0fhas_more_voters\x18\x12 \x01(\bB\x03\xe0A\x03R\rhasMoreVoters\"\xb2\x01\n" +
	"\tPollVoter\x12\x12\n" +
	...
	"\x13selected_option_ids\x18\x05 \x03(\tB\x03\xe0A\x03R\x11selectedOptionIds\"\x93\x01\n" +
	"\n" +
	"PollOption\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x17\n" +
	"\x04text\x18\x02 \x01(\tB\x03\xe0A\x02R\x04text\x123\n" +
	"\x05image\x18\x03 \x01(\v2\x18.memos.api.v1.AttachmentB\x03\xe0A\x01R\x05image\x12\"\n" +
	"\n" +
	"vote_count\x18\x04 \x01(\x05B\x03\xe0A\x03R\tvoteCount\"\x84\x01\n" +
	...
	"\x11memos.api.v1/MemoR\x04name\"l\n" +
	"\x15RecordMemoViewRequest\x12-\n" +
	"\x04name\x18\x01 \x01(\tB\x19\xe0A\x02\xfaA\x13\n" +
	"\x11memos.api.v1/MemoR\x04name\x12$\n" +
	"\vshare_token\x18\x02 \x01(\tB\x03\xe0A\x01R\n" +
	"shareToken\"7\n" +
	"\x16RecordMemoViewResponse\x12\x1d\n" +
	"\n" +
	"view_count\x18\x01 \x01(\x03R\tviewCount\"\x82\x01\n" +
	...
	"\x05SPACE\x10\x04*F\n" +
	"\tVoterType\x12\x1a\n" +
	"\x16VOTER_TYPE_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rAUTHENTICATED\x10\x01\x12\n" +
	"\n" +
	"\x06ANYONE\x10\x022\xa4\x16\n" +
	"\vMemoService\x12e\n" +
	"\n" +
	...
	"\aGetMemo\x12\x1c.memos.api.v1.GetMemoRequest\x1a\x12.memos.api.v1.Memo\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/{name=memos/*}\x12\x90\x01\n" +
	"\x0eRecordMemoView\x12#.memos.api.v1.RecordMemoViewRequest\x1a$.memos.api.v1.RecordMemoViewResponse\"3\xdaA\x04name\x82\xd3\xe4\x93\x02&:\x01*\"!/api/v1/{name=memos/*}:recordView\x12\x7f\n" +
	"\n" +
...
var file_api_v1_memo_service_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_api_v1_memo_service_proto_goTypes = []any{
	(Visibility)(0),                      // 0: memos.api.v1.Visibility
	(VoterType)(0),                       // 1: memos.api.v1.VoterType
	...
	(*Poll)(nil),                         // 8: memos.api.v1.Poll
	(*PollVoter)(nil),                    // 9: memos.api.v1.PollVoter
	(*PollOption)(nil),                   // 10: memos.api.v1.PollOption
	(*ListMemosResponse)(nil),            // 11: memos.api.v1.ListMemosResponse
	(*GetMemoRequest)(nil),               // 12: memos.api.v1.GetMemoRequest
	(*RecordMemoViewRequest)(nil),        // 13: memos.api.v1.RecordMemoViewRequest
	(*RecordMemoViewResponse)(nil),       // 14: memos.api.v1.RecordMemoViewResponse
	(*UpdateMemoRequest)(nil),            // 15: memos.api.v1.UpdateMemoRequest
	...
	(*GetSharedMemoRequest)(nil),         // 36: memos.api.v1.GetSharedMemoRequest
	(*GetLinkMetadataRequest)(nil),       // 37: memos.api.v1.GetLinkMetadataRequest
	(*BatchGetLinkMetadataRequest)(nil),  // 38: memos.api.v1.BatchGetLinkMetadataRequest
	(*BatchGetLinkMetadataResponse)(nil), // 39: memos.api.v1.BatchGetLinkMetadataResponse
	(*LinkMetadata)(nil),                 // 40: memos.api.v1.LinkMetadata
	(*Memo_Property)(nil),                // 41: memos.api.v1.Memo.Property
	(*MemoRelation_Memo)(nil),            // 42: memos.api.v1.MemoRelation.Memo
	(*timestamppb.Timestamp)(nil),        // 43: google.protobuf.Timestamp
	(State)(0),                           // 44: memos.api.v1.State
	(*Attachment)(nil),                   // 45: memos.api.v1.Attachment
	(*fieldmaskpb.FieldMask)(nil),        // 46: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                // 47: google.protobuf.Empty
}
var file_api_v1_memo_service_proto_depIdxs = []int32{
	43, // 0: memos.api.v1.Reaction.create_time:type_name -> google.protobuf.Timestamp
	44, // 1: memos.api.v1.Memo.state:type_name -> memos.api.v1.State
	43, // 2: memos.api.v1.Memo.create_time:type_name -> google.protobuf.Timestamp
	43, // 3: memos.api.v1.Memo.update_time:type_name -> google.protobuf.Timestamp
	0,  // 4: memos.api.v1.Memo.visibility:type_name -> memos.api.v1.Visibility
	45, // 5: memos.api.v1.Memo.attachments:type_name -> memos.api.v1.Attachment
	...
	43, // 10: memos.api.v1.Memo.publish_time:type_name -> google.protobuf.Timestamp
	8,  // 11: memos.api.v1.Memo.poll:type_name -> memos.api.v1.Poll
	4,  // 12: memos.api.v1.CreateMemoRequest.memo:type_name -> memos.api.v1.Memo
	44, // 13: memos.api.v1.ListMemosRequest.state:type_name -> memos.api.v1.State
	45, // 14: memos.api.v1.Poll.image:type_name -> memos.api.v1.Attachment
	10, // 15: memos.api.v1.Poll.options:type_name -> memos.api.v1.PollOption
	1,  // 16: memos.api.v1.Poll.voter_type:type_name -> memos.api.v1.VoterType
	43, // 17: memos.api.v1.Poll.start_time:type_name -> google.protobuf.Timestamp
	43, // 18: memos.api.v1.Poll.end_time:type_name -> google.protobuf.Timestamp
	9,  // 19: memos.api.v1.Poll.voters:type_name -> memos.api.v1.PollVoter
	45, // 20: memos.api.v1.PollOption.image:type_name -> memos.api.v1.Attachment
	4,  // 21: memos.api.v1.ListMemosResponse.memos:type_name -> memos.api.v1.Memo
	4,  // 22: memos.api.v1.UpdateMemoRequest.memo:type_name -> memos.api.v1.Memo
	46, // 23: memos.api.v1.UpdateMemoRequest.update_mask:type_name -> google.protobuf.FieldMask
	45, // 24: memos.api.v1.SetMemoAttachmentsRequest.attachments:type_name -> memos.api.v1.Attachment
	45, // 25: memos.api.v1.ListMemoAttachmentsResponse.attachments:type_name -> memos.api.v1.Attachment
	42, // 26: memos.api.v1.MemoRelation.memo:type_name -> memos.api.v1.MemoRelation.Memo
	42, // 27: memos.api.v1.MemoRelation.related_memo:type_name -> memos.api.v1.MemoRelation.Memo
	2,  // 28: memos.api.v1.MemoRelation.type:type_name -> memos.api.v1.MemoRelation.Type
	20, // 29: memos.api.v1.SetMemoRelationsRequest.relations:type_name -> memos.api.v1.MemoRelation
	20, // 30: memos.api.v1.ListMemoRelationsResponse.relations:type_name -> memos.api.v1.MemoRelation
	4,  // 31: memos.api.v1.CreateMemoCommentRequest.comment:type_name -> memos.api.v1.Memo
	4,  // 32: memos.api.v1.ListMemoCommentsResponse.memos:type_name -> memos.api.v1.Memo
	3,  // 33: memos.api.v1.ListMemoReactionsResponse.reactions:type_name -> memos.api.v1.Reaction
	3,  // 34: memos.api.v1.UpsertMemoReactionRequest.reaction:type_name -> memos.api.v1.Reaction
	43, // 35: memos.api.v1.MemoShare.create_time:type_name -> google.protobuf.Timestamp
	43, // 36: memos.api.v1.MemoShare.expire_time:type_name -> google.protobuf.Timestamp
	31, // 37: memos.api.v1.CreateMemoShareRequest.memo_share:type_name -> memos.api.v1.MemoShare
	31, // 38: memos.api.v1.ListMemoSharesResponse.memo_shares:type_name -> memos.api.v1.MemoShare
	40, // 39: memos.api.v1.BatchGetLinkMetadataResponse.link_metadata:type_name -> memos.api.v1.LinkMetadata
	...
	12, // 42: memos.api.v1.MemoService.GetMemo:input_type -> memos.api.v1.GetMemoRequest
	13, // 43: memos.api.v1.MemoService.RecordMemoView:input_type -> memos.api.v1.RecordMemoViewRequest
	15, // 44: memos.api.v1.MemoService.UpdateMemo:input_type -> memos.api.v1.UpdateMemoRequest
	16, // 45: memos.api.v1.MemoService.DeleteMemo:input_type -> memos.api.v1.DeleteMemoRequest
	17, // 46: memos.api.v1.MemoService.SetMemoAttachments:input_type -> memos.api.v1.SetMemoAttachmentsRequest
	18, // 47: memos.api.v1.MemoService.ListMemoAttachments:input_type -> memos.api.v1.ListMemoAttachmentsRequest
	21, // 48: memos.api.v1.MemoService.SetMemoRelations:input_type -> memos.api.v1.SetMemoRelationsRequest
	22, // 49: memos.api.v1.MemoService.ListMemoRelations:input_type -> memos.api.v1.ListMemoRelationsRequest
	24, // 50: memos.api.v1.MemoService.CreateMemoComment:input_type -> memos.api.v1.CreateMemoCommentRequest
	25, // 51: memos.api.v1.MemoService.ListMemoComments:input_type -> memos.api.v1.ListMemoCommentsRequest
	27, // 52: memos.api.v1.MemoService.ListMemoReactions:input_type -> memos.api.v1.ListMemoReactionsRequest
	29, // 53: memos.api.v1.MemoService.UpsertMemoReaction:input_type -> memos.api.v1.UpsertMemoReactionRequest
	30, // 54: memos.api.v1.MemoService.DeleteMemoReaction:input_type -> memos.api.v1.DeleteMemoReactionRequest
	32, // 55: memos.api.v1.MemoService.CreateMemoShare:input_type -> memos.api.v1.CreateMemoShareRequest
	33, // 56: memos.api.v1.MemoService.ListMemoShares:input_type -> memos.api.v1.ListMemoSharesRequest
	35, // 57: memos.api.v1.MemoService.DeleteMemoShare:input_type -> memos.api.v1.DeleteMemoShareRequest
	36, // 58: memos.api.v1.MemoService.GetSharedMemo:input_type -> memos.api.v1.GetSharedMemoRequest
	37, // 59: memos.api.v1.MemoService.GetLinkMetadata:input_type -> memos.api.v1.GetLinkMetadataRequest
	38, // 60: memos.api.v1.MemoService.BatchGetLinkMetadata:input_type -> memos.api.v1.BatchGetLinkMetadataRequest
	4,  // 61: memos.api.v1.MemoService.CreateMemo:output_type -> memos.api.v1.Memo
	11, // 62: memos.api.v1.MemoService.ListMemos:output_type -> memos.api.v1.ListMemosResponse
	4,  // 63: memos.api.v1.MemoService.GetMemo:output_type -> memos.api.v1.Memo
	14, // 64: memos.api.v1.MemoService.RecordMemoView:output_type -> memos.api.v1.RecordMemoViewResponse
	4,  // 65: memos.api.v1.MemoService.UpdateMemo:output_type -> memos.api.v1.Memo
	47, // 66: memos.api.v1.MemoService.DeleteMemo:output_type -> google.protobuf.Empty
	47, // 67: memos.api.v1.MemoService.SetMemoAttachments:output_type -> google.protobuf.Empty
	19, // 68: memos.api.v1.MemoService.ListMemoAttachments:output_type -> memos.api.v1.ListMemoAttachmentsResponse
	47, // 69: memos.api.v1.MemoService.SetMemoRelations:output_type -> google.protobuf.Empty
	23, // 70: memos.api.v1.MemoService.ListMemoRelations:output_type -> memos.api.v1.ListMemoRelationsResponse
	4,  // 71: memos.api.v1.MemoService.CreateMemoComment:output_type -> memos.api.v1.Memo
	26, // 72: memos.api.v1.MemoService.ListMemoComments:output_type -> memos.api.v1.ListMemoCommentsResponse
	28, // 73: memos.api.v1.MemoService.ListMemoReactions:output_type -> memos.api.v1.ListMemoReactionsResponse
	3,  // 74: memos.api.v1.MemoService.UpsertMemoReaction:output_type -> memos.api.v1.Reaction
	47, // 75: memos.api.v1.MemoService.DeleteMemoReaction:output_type -> google.protobuf.Empty
	31, // 76: memos.api.v1.MemoService.CreateMemoShare:output_type -> memos.api.v1.MemoShare
	34, // 77: memos.api.v1.MemoService.ListMemoShares:output_type -> memos.api.v1.ListMemoSharesResponse
	47, // 78: memos.api.v1.MemoService.DeleteMemoShare:output_type -> google.protobuf.Empty
	4,  // 79: memos.api.v1.MemoService.GetSharedMemo:output_type -> memos.api.v1.Memo
	40, // 80: memos.api.v1.MemoService.GetLinkMetadata:output_type -> memos.api.v1.LinkMetadata
	39, // 81: memos.api.v1.MemoService.BatchGetLinkMetadata:output_type -> memos.api.v1.BatchGetLinkMetadataResponse
...
func file_api_v1_memo_service_proto_init() {
	...
	file_api_v1_memo_service_proto_msgTypes[28].OneofWrappers = []any{}
	type x struct{}
