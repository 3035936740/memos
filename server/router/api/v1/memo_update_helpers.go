...
func (s *APIV1Service) dispatchMemoUpdatedSideEffects(ctx context.Context, memo *store.Memo, commentContext *store.Memo, memoMessage *v1pb.Memo) {
	...
	if commentContext != nil {
		visibility = commentContext.Visibility
	}
	s.SSEHub.Broadcast(&SSEEvent{
		...
		CreatorID:  resolveSSECreatorID(memo, commentContext),
	})
